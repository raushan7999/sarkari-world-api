...
from sarkariworld.dependencies import AuthedUser, SessionDep, require_auth
from sarkariworld.exceptions import NotFoundError
from sarkariworld.schemas.bookmark import (
    BookmarkedArticle,
    BookmarkItem,
    BookmarkToggleRequest,
    BookmarkToggleResponse,
)
from sarkariworld.schemas.common import AUTH_RESPONSES
from sarkariworld.schemas.pagination import PublicPage, public_page_params
from sarkariworld.services import bookmarks
from sarkariworld.utils.logger import get_logger
from sarkariworld.utils.slugs import category_enum_to_slug
